...
public class ArraySearch {
    public static void main(String[] args) {
        ...
        System.out.println("9-firstList.containsAll(Arrays.asList(anotherUnsortedSet)) =  "
                + firstList.containsAll(Arrays.asList(anotherUnsortedSet)));

        // Use indexOf to get first matching element
        System.out.println("10-secondList.indexOf(\"jkl\") =  "
                + secondList.indexOf("jkl"));

        // Use lastIndexOf to to get last matching element
        System.out.println("11-secondList.lastIndexOf(\"jkl\") =  "
